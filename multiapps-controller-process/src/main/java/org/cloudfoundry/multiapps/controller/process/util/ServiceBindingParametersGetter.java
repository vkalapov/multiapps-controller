...
public class ServiceBindingParametersGetter {
    ...
    public Map<String, Object> getServiceBindingParametersFromMta(CloudApplicationExtended app,
                                                                  String serviceName) {
    ...
    private Optional<CloudServiceInstanceExtended> getService(List<CloudServiceInstanceExtended> services,
                                                              String serviceName) {
    ...
    private Map<String, Object> getFileProvidedBindingParameters(String moduleName,
        ...
        String resolvedJson = (String) context.getVariable(Variables.MTA_ARCHIVE_JSONS)
                                              .get(requiredDependencyName);
        return JsonUtil.convertJsonToMap(resolvedJson);
    }

    private Map<String, Object> getDescriptorProvidedBindingParameters(CloudApplicationExtended app,
                                                                       CloudServiceInstanceExtended service) {
    ...
    public String getDescriptorProvidedBindingName(CloudApplicationExtended app,
                                                   String serviceName) {
        Optional<CloudServiceInstanceExtended> service = getService(context.getVariable(Variables.SERVICES_TO_BIND), serviceName);
        if (service.isEmpty()) {
            return null;
    ...
    public Map<String, Object> getServiceBindingParametersFromExistingInstance(CloudApplication application,
                                                                               String serviceName) {
        ...
        try {
            ...
            if (HttpStatus.NOT_IMPLEMENTED == e.getStatusCode() || HttpStatus.BAD_REQUEST == e.getStatusCode()) {
                ...
                context.getStepLogger()
                       .warnWithoutProgressMessage(Messages.CANNOT_RETRIEVE_PARAMETERS_OF_BINDING_BETWEEN_APPLICATION_0_AND_SERVICE_INSTANCE_1, application.getName(), serviceName);
                return null;
                ...
                context.getStepLogger()
                       .warnWithoutProgressMessage(Messages.CANNOT_RETRIEVE_PARAMETERS_OF_BINDING_BETWEEN_APPLICATION_0_AND_SERVICE_INSTANCE_1_FIX, application.getName(), serviceName);
                return null;
            }
            throw e;
        }
